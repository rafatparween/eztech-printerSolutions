...
import { 
  ...
  Computer, Scanner, InstallDesktop, Troubleshoot
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20" id="printer-setup">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1">
              <img
                src="https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHByaW50ZXIlMjBzZXR1cHxlbnwwfHwwfHx8MA%3D%3D"
                alt="Printer setup"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100">
              ...
              <div className="bg-teal-50 p-6 rounded-xl border-l-4 border-teal-500">
                <h4 className="font-semibold text-teal-700 mb-4">Get Reliable Printer Support Anytime</h4>
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">"Chat with an expert now"</span>
                  </div>
                  <div className="flex items-center">
                    <div className="bg-teal-500 text-white w-7 h-7 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <span className="text-sm font-bold">2</span>
                    </div>
                    <span className="text-gray-700">"Start your setup in minutes"</span>
                  </div>
                  <div className="flex items-center">
                    <div className="bg-teal-500 text-white w-7 h-7 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <span className="text-sm font-bold">3</span>
                    </div>
                    <span className="text-gray-700">"Click to connect instantly"</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-10 mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Our support team is available whenever you need assistance</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Support Available 24/7</h3>
              </div>
              <p className="text-gray-700 mb-8 text-lg">
                Get online support anytime, day or night. Connect with us online or by phone in minutes for immediate assistance!
              </p>
            ...
            <div className="flex-1">
              <img
                ...
                src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHN1cHBvcnQlMjB0ZWFtfGVufDB8fDB8fHww"
                alt="Support team"
              />
            </div>
          </div>

...
const Services = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        {/* Support Section */}
        <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-10 mb-20 mt-[90px] container mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 w-full">
              ...
              <p className="text-gray-700 mb-8 text-base sm:text-lg leading-relaxed">
                Get expert support during business hours. Connect with us online
                or by phone for immediate assistance!
              </p>
            ...
            <div className="flex-1 w-full">
              <img
                ...
                src="https://plus.unsplash.com/premium_photo-1705091310225-c5af0c6d64b5?w=600&auto=format&fit=crop&q=60"
                alt="Support team"
              />
            </div>
          </div>
        ...
        {/* CTA Section */}
        <section className="bg-[#1C8DCEED] rounded-2xl p-6 sm:p-10 text-center text-white container mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            Ready to Get Your Printer Working?
          </h2>
          <p className="text-base sm:text-xl mb-8 max-w-2xl mx-auto">
            Our team of printer experts is ready to help you with all your
            printing needs
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-white text-[#1C8DCEED] font-semibold py-3 px-8 rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors text-sm sm:text-base">
              <Chat className="mr-2" />
              Chat with an Expert
            </button>
            <button className="border-2 border-white text-white font-semibold py-3 px-8 rounded-lg hover:bg-white/10 transition-colors text-sm sm:text-base">
              Schedule a Service
            </button>
          </div>
        </section>
        ...
        {/* ✅ Main Content (Updated with your provided code) */}
        <main className="container mx-auto px-4 py-16">
          {/* Installation & Setup */}
          <section className="mb-20" id="installation">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <ServiceCard
                icon={<Print className="text-white text-3xl" />}
                title="Printer Setup"
                description="Configure wired or wireless printers for smooth operation."
              />
              <ServiceCard
                icon={<Scanner className="text-white text-3xl" />}
                title="Scanner & Device Setup"
                description="Installation and connection for scanners or multifunction devices."
              />
              <ServiceCard
                icon={<Download className="text-white text-3xl" />}
                title="Software & Driver Assistance"
                description="Ensure your system has the latest drivers and software for compatibility."
              />
            </div>
          </section>

          {/* IT & Device Assistance */}
          <section className="mb-20" id="assistance">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-3">
                IT & Device Assistance
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <ServiceCard
                ...
                description="Help with Wi-Fi, Bluetooth, and device connections."
              />
              <ServiceCard
                icon={<Speed className="text-white" />}
                title="System Performance Optimization"
                description="Improve speed and responsiveness with cleanup and configuration."
              />
              <ServiceCard
                icon={<Storage className="text-white" />}
                title="Backup & Transfer Guidance"
                description="Assistance with moving files securely to new devices."
              />
              <ServiceCard
                icon={<School className="text-white" />}
                title="User Training & Lessons"
                description="Step-by-step support to help you use your devices confidently."
              />
            </div>
          </section>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="flex-1">
                <Feature
                  ...
                  title="Assistance with setting up new printers"
                  description="(wired or wireless)"
                />
                <Feature
                  icon={<Wifi className="text-white" />}
                  title="Help with connecting printers"
                  description="to Wi-Fi, networks, and devices"
                />
                <Feature
                  icon={<Download className="text-white" />}
                  title="Step-by-step guidance"
                  description="for driver and software installation"
                />
              </div>
            </div>
          </section>
          ...
          <section className="mb-20" id="optimization">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-3">
                Printer Optimization & Support
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Keep your printer running at its best
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100">
                ...
                <p className="text-gray-700 mb-6">
                  Assistance with keeping your printer running smoothly
                </p>

                <div className="bg-gray-100 p-6 rounded-xl border-l-4 border-[#1C8DCEED]">
                  <h4 className="font-semibold text-[#1C8DCEED] mb-4">
                    Professional Printer Support
                  </h4>
                  <div className="space-y-3">
                    <Step number="1">
                      Help with paper feed, print quality, and common
                      troubleshooting.
                    </Step>
                    <Step number="2">
                      Assistance with keeping your printer running smoothly
...
const ServiceCard = ({ icon, title, description }) => (
  <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-all border border-gray-100 transform hover:-translate-y-1 duration-300">
    <div className="bg-[#1C8DCEED] w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6">
      {icon}
    </div>
